var pageComponent =
webpackJsonppageComponent([7,17,18,19,20,21],[
/* 0 */
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('main', null, null,
      ...
      ie_open('div', null, null,
          'class', 'docs');
        $templateAlias1({items: opt_data.site.topbar, style: 'topbar-light topbar-docs', logo: {text: opt_data.site.logo + ' ' + opt_data.site.title}}, null, opt_ijData);
        $templateAlias2({section: opt_data.site.index.children['docs'], site: opt_data.site}, null, opt_ijData);
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'row');
              var childIdList304 = opt_data.page.childIds;
              var childIdListLen304 = childIdList304.length;
              for (var childIdIndex304 = 0; childIdIndex304 < childIdListLen304; childIdIndex304++) {
                var childIdData304 = childIdList304[childIdIndex304];
                var topic__soy294 = opt_data.page.children[childIdData304];
                if (! topic__soy294.hidden) {
                  ie_open('div', null, null,
                      'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
                    ie_open('a', null, null,
                        'class', 'topic radial-out',
                        'href', topic__soy294.url);
                      ie_open('div', null, null,
                          'class', 'topic-icon');
                        ie_void('span', null, null,
                            'class', 'icon-16-' + topic__soy294.icon);
                      ie_close('div');
                      ie_open('h3', null, null,
                          'class', 'topic-title');
                        var dyn27 = topic__soy294.title;
