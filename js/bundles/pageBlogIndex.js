var pageComponent =
webpackJsonppageComponent([16,17,18,19,20,21],[
/* 0 */
...
function $allPosts(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
        'class', 'container');
      var childIdList251 = opt_data.site.index.children['blog'].childIds;
      var childIdListLen251 = childIdList251.length;
      for (var childIdIndex251 = 0; childIdIndex251 < childIdListLen251; childIdIndex251++) {
        var childIdData251 = childIdList251[childIdIndex251];
        var childPage__soy239 = opt_data.site.index.children['blog'].children[childIdData251];
        ie_open('article', null, null,
            'class', 'post-item container-blog');
          ie_open('a', null, null,
              'class', 'post-item__link',
              'href', childPage__soy239.url);
            ie_open('small');
              itext('By ');
              var dyn20 = childPage__soy239.author;
              if (typeof dyn20 == 'function') dyn20(); else if (dyn20 != null) itext(dyn20);
              itext(' ');
              ie_open('span');
                itext('| ');
                var dyn21 = childPage__soy239.date;
                if (typeof dyn21 == 'function') dyn21(); else if (dyn21 != null) itext(dyn21);
              ie_close('span');
            ie_close('small');
            ie_open('h4', null, null,
                'class', 'post-item__title');
              var dyn22 = childPage__soy239.title;
              if (typeof dyn22 == 'function') dyn22(); else if (dyn22 != null) itext(dyn22);
            ie_close('h4');
            ie_open('p');
              var dyn23 = childPage__soy239.description;
              if (typeof dyn23 == 'function') dyn23(); else if (dyn23 != null) itext(dyn23);
            ie_close('p');
          ie_close('a');
        ie_close('article');
