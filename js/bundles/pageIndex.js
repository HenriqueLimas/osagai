var pageComponent =
webpackJsonppageComponent([0,9,10,11,12,13],[
/* 0 */
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ...
  $templateAlias1(soy.$$assignDefaults({content: param99}, opt_data), null, opt_ijData);
}
...
function $olderPosts(opt_data, opt_ignored, opt_ijData) {
  var blogObject__soy119 = opt_data.site.index.children['blog'];
  $templateAlias3({blogObject: blogObject__soy119, url: opt_data.page.url}, null, opt_ijData);
}
  ...
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('h6', null, null,
        ...
        var dyn15 = opt_data.site.index.children['tutorials'].children[opt_data.page.parentId].tutorialTitle;
...
function $footerButtons(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    var tutorialObject__soy198 = opt_data.site.index.children['tutorials'].children[opt_data.page.parentId];
    if (opt_data.page.weight < tutorialObject__soy198.childIds.length) {
      if (opt_data.page.buttonTitle) {
        var nextPageUrl__soy203 = tutorialObject__soy198.children[tutorialObject__soy198.childIds[opt_data.page.weight]].url;
        ie_open('a', null, null,
            'href', nextPageUrl__soy203,
            'class', 'btn btn-accent btn-sm');
          var dyn17 = opt_data.page.buttonTitle;
 ...
 * @suppress {checkTypes}
 */
function __deltemplate_s218_88c0813b(opt_data, opt_ignored, opt_ijData) {
  ie_open('a', null, null,
...
exports.__deltemplate_s218_88c0813b = __deltemplate_s218_88c0813b;
if (goog.DEBUG) {
  __deltemplate_s218_88c0813b.soyTemplateName = 'tutorial.__deltemplate_s218_88c0813b';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ElectricNavigation.anchor.idom'), 'tutorial', 0, __deltemplate_s218_88c0813b);
 ...
 * @suppress {checkTypes}
 */
function __deltemplate_s61_d34389eb(opt_data, opt_ignored, opt_ijData) {
  ie_open('a', null, null,
      'class', 'sidebar-link ' + (opt_data.page.active ? 'sidebar-link-selected' : ''),
      'href', opt_data.page.url);
...
exports.__deltemplate_s61_d34389eb = __deltemplate_s61_d34389eb;
if (goog.DEBUG) {
  __deltemplate_s61_d34389eb.soyTemplateName = 'Sidebar.__deltemplate_s61_d34389eb';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ElectricNavigation.anchor.idom'), 'sidebar', 0, __deltemplate_s61_d34389eb);
  ...
  ie_open('header', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('h2', null, null,
        ...
        var dyn2 = opt_data.site.index.description;
        if (typeof dyn2 == 'function') dyn2(); else if (dyn2 != null) itext(dyn2);
      ie_close('h2');
    ...
    ie_open('p', null, null,
      ...
      ie_void('iframe', null, null,
          'src', '//ghbtns.com/github-btn.html?user=HenriqueLimas&repo=osagai&type=watch&count=true&size=large',
          ...
          'height', '30');
      ie_void('iframe', null, null,
          'src', '//ghbtns.com/github-btn.html?user=HenriqueLimas&repo=osagai&type=fork&count=true&size=large',
          'allowtransparency', 'true',
          'frameborder', '0',
          'scrolling', '0',
          'width', '150',
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
            ...
            itext('Creating WebComponents shouldn\'t be limited to extending classes and it should use native solution and no magic.');
            ie_open('br');
            ie_close('br');
            itext(' Osagai is a library that make WebComponents easier to create and use with only composing functions and ');
            ie_open('a', null, null,
                'href', 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals',
                'title', 'Template literals link on MDN');
              itext('template literals');
            ie_close('a');
            itext('.');
          ie_close('p');
        ie_close('div');
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('section', null, null,
          ...
          ie_open('h3', null, null,
              'class', 'feature-title');
            itext('Easy to create');
          ie_close('h3');
          ie_open('p', null, null,
              'class', 'feature-description');
            itext('Create and easily define WebComponents using functions. No needs to extends classes and OOO things.');
          ie_close('p');
        ie_close('section');
        ie_open('section', null, null,
          ...
          ie_open('p', null, null,
              'class', 'feature-description');
            itext('Update when you say to update. It compares the current DOM tree with the new one and update only what it needs to be updated using the amazing ');
            ie_open('a', null, null,
        ...
        ie_open('section', null, null,
          ...
          ie_open('h3', null, null,
              'class', 'feature-title');
            itext('Framework agnostic');
          ie_close('h3');
          ie_open('p', null, null,
              'class', 'feature-description');
            itext('Take advantage of WebComponents purpose and use your component in whatever Framework/Library.');
          ie_close('p');
        ie_close('section');
      ie_close('div');
    ie_close('div');
      ...
      ie_open('section', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('h4', null, null,
            ...
            itext('Simple component');
          ie_close('h4');
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('Osagai export a ');
            ie_open('code');
              itext('define()');
            ie_close('code');
            itext(' function to create your WebComponent. Your component is a function that returns a template with the view definition');
          ie_close('p');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-md-7  col-md-offset-1');
          ie_void('iframe', null, null,
              'class', 'gist simple-component',
              'src', 'https://gist.github.com/HenriqueLimas/d7bfb65a4e3fbdf6c09de3aa96ce6ae7.pibb');
        ie_close('div');
      ie_close('section');
      ie_open('section', null, null,
          'class', 'highlight row');
        ie_open('div', null, null,
          ...
          ie_open('h4', null, null,
              'class', 'highlight-title');
            itext('Adding event listeners');
          ie_close('h4');
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('In addition, in you component function it will be injected some useful methods like ');
            ie_open('code');
              itext('query');
            ie_close('code');
            itext(' that you could query inside the component tree and add event listeners with the ');
            ie_open('code');
              itext('on');
            ie_close('code');
            itext(' method from ');
        ...
        ie_open('div', null, null,
            'class', 'col-md-7  col-md-offset-1');
          ie_void('iframe', null, null,
              'class', 'gist event-listener',
              'src', 'https://gist.github.com/HenriqueLimas/9329005145894cbb4e62a343ced7eb43.pibb');
        ie_close('div');
      ie_close('section');
      ie_open('section', null, null,
          'class', 'highlight row');
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
            ...
            ie_open('code');
              itext('query');
            ie_close('code');
            itext(', Osagai will also inject an ');
            ie_open('code');
              itext('update');
            ie_close('code');
            itext(' function that you can use for changing the data (or state) being used in the template function. This will check what it needs to be changed in the DOM and apply the re-render');
          ie_close('p');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-md-7  col-md-offset-1');
          ie_void('iframe', null, null,
              'class', 'gist application-example',
              'src', 'https://gist.github.com/HenriqueLimas/dc75ac3595c44ef1b330f18d2cd0dc56.pibb');
        ie_close('div');
      ie_close('section');
      ie_open('section', null, null,
          'class', 'highlight row');
        ie_open('div', null, null,
          ...
          ie_open('h4', null, null,
              'class', 'highlight-title');
            itext('A real application');
          ie_close('h4');
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('This a "real" example of the Hacker News implemented with Osagai as a PWA. You can se the code on ');
            ie_open('a', null, null,
                'href', 'https://github.com/HenriqueLimas/osagai-hn');
              itext('Github');
            ie_close('a');
            itext(', or try it live ');
            ie_open('a', null, null,
                'href', 'https://osagai-hn.firebaseapp.com/');
              itext('here');
            ie_close('a');
            itext('.');
          ie_close('p');
        ...
        ie_open('div', null, null,
          ...
          ie_void('iframe', null, null,
              'class', 'gist application-example',
              'src', 'https://osagai-hn.firebaseapp.com/');
        ie_close('div');
      ie_close('section');
    ie_close('div');
  ie_close('div');
